...
/// [ExpansionTileList] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
class _ExpansionTileListState extends State<ExpansionTileList> with SingleTickerProviderStateMixin {
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      widget.trailing ?? RotationTransition(
                        turns: _iconTurns,
                        child:  Icon(Icons.expand_more,color: AppColors.IconList,size: SizeConfig.scaleHeight(24),),
                      ),
                    ],
                  ),
                ),
            ...
            //     turns: _iconTurns,
            //     child: const Icon(Icons.expand_more,color:AppColors.IconList,),
            //   ),
            // ),
          ),
          ClipRect(
